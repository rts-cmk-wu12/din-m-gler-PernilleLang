    ...
    return(
            <section className="relative bg-[url('/baggrund.jpg')] bg-cover bg-center h-[65vh] w-[100vw] flex flex-col justify-center items-center">
                ...
                <div className="bg-white z-10 h-[7em] w-[40em] p-[1em]">
                        ...
                        <div>
                            <input type="text" placeholder="Søg på fx. glaskeramisk komfur, bryggers, kælder eller lignende" className="w-[35em] h-[2.7em] text-[0.7em] border border-gray-200 rounded-sm" />
                            <button className="text-[0.5em] bg-blue-950 text-white mr-[1em] ml-[1em] w-[8em] h-[4.1em] border rounded-[0.5em]">Søg</button>
                        </div>
                </div>
            </section>
    )
